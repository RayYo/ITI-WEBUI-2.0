<template>
  <div class="main_body">
    <div id="basetitle">Ingress Rate Limiting</div>
    <div class="table_title">Ingress Rate Limiting Settings<span style="font-size: 14px; margin-left: 14px">(Bandwidth = 64kbps x rate limit)</span></div>
    <port-edit-table
      :columns="columns"
      :rows="rows"
      min-width="900px"
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: 'bandwidth', label: 'Bandwidth', minWidth: 260, type: 'input', maxlength: 6, prefix: '64kbps x', suffix: '(1-15625)', inputWidth: '70px' },
  ...
  methods: {
    ...
    onApply(row) {
      ...
      cgiSet('net_ingressRateEdit', payload).then(() => this.load())
    }
  }
}
</script>
